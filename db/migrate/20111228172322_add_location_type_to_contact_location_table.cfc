...
--->
<cfcomponent extends="np.plugins.dbmigrate.Migration" hint="add location type to contact location table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='tblcontactlocations', columnType='string', columnName='location_type', default='', null=true, limit='255');
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='tblcontactlocations',columnName='location_type');
    </cfscript>
  </cffunction>
</cfcomponent>
